    ...
    <div className="font-display bg-background-light dark:bg-background-dark text-slate-900 dark:text-slate-100 min-h-screen flex items-center justify-center p-4">
      <div className="w-full max-w-md">
        ...
        <div className="bg-white dark:bg-slate-800/50 rounded-xl shadow-xl shadow-slate-200/50 dark:shadow-none border border-slate-200 dark:border-slate-700 p-8">
          ...
          <form className="space-y-5" onSubmit={handleLogin}>
            ...
            <div className="flex items-center">
              <input className="h-4 w-4 rounded border-slate-300 text-primary focus:ring-primary bg-white dark:bg-slate-900" id="remember" name="remember" type="checkbox" />
          ...
          <div className="relative my-8">
            ...
            <div className="relative flex justify-center text-sm">
              <span className="px-2 bg-white dark:bg-slate-800 text-slate-500 dark:text-slate-400 uppercase tracking-wider text-[10px] font-bold">Or continue with</span>
            </div>
          </div>
        ...
        <p className="mt-8 text-center text-sm text-slate-600 dark:text-slate-400">
          ...
          <Link className="font-semibold text-primary hover:underline" to="/register">Sign up for free</Link>
        </p>
